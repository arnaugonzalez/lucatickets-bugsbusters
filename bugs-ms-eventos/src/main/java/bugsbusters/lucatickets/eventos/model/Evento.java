...
/**
 * Clase que representa un evento en el sistema LucaTickets.
 * Esta clase contiene información sobre un evento, como su nombre, descripción, fecha, hora, precio, etc.
 */
@Entity
@Table(name = "eventos")
@NoArgsConstructor
